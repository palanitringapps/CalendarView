...
import com.calendarrscalendar.calendar.MonthCellDescriptor.RangeState;
...
public class CalendarPickerView extends ListView {
  ...
  private class MonthAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (monthView == null
        ...
        monthView =
            MonthView.create(parent, inflater, weekdayNameFormat, listener, today, dividerColor,
                ...
                headerTextColor, decorators, locale, dayViewAdapter,2);
      ...
      /*monthView.initTitle(months.get(position), cells.get(position), displayOnly, titleTypeface,
              dateTypeface);*/
      return monthView;
    }
  }
